...
def load_digested_peptides_var_mods(targets,  max_length, varMods = {}, varNtermMods = {}, varCtermMods = {}):
    """
    """
    ...
    with open(targets, 'rb') as fid:
        for peptide in read_binary_peptide_tuples(s, fid):
            ...
            cterm_flanking = peptide[4]
            if isVarMods:
                varModSequence = peptide[5][:len(p)]
                digested_peptides.append((static_mod_mass, p, protein_num, nterm_flanking, cterm_flanking, varModSequence))
            else:
                digested_peptides.append((static_mod_mass, p, protein_num, nterm_flanking, cterm_flanking))
...
if __name__ == '__main__':
    ...
    help_digest_dir = '<string> - Digestion output file.  Default=digest-output.'
    iFileGroup.add_argument('--digest-dir', type = str, action = 'store',
                        help = help_digest_dir, default = 'digest-output')
